...
firewall-cmd --permanent --zone=public --add-port=80/tcp --add-port=8080/tcp --add-port=8081/tcp --add-port=1234/tcp --add-port=1235/tcp --add-port=1236/tcp --add-port=8082/tcp
firewall-cmd --permanent --zone=public --add-protocol=icmp
# authorized ports for the eth0
firewall-cmd --permanent --zone=work --add-port=1234/tcp --add-port=1235/tcp --add-port=1236/tcp --add-port=22/tcp --add-port=80/tcp --add-port=443/tcp --add-port=8080/tcp --add-port=8082/tcp
firewall-cmd --permanent --zone=work --add-service=cockpit
# authorized ports for the wlan0
firewall-cmd --permanent --zone=external --add-port=80/tcp --add-port=443/tcp --add-port=8080/tcp --add-port=8081/tcp --add-port=1234/tcp --add-port=1235/tcp --add-port=1236/tcp --add-port=8082/tcp
